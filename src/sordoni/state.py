...
def dev():
    ...
    state['train_session'] = "data/dev/train.ses.pkl"
    state['train_rank'] = "data/dev/train.rnk.pkl"
    state['valid_session'] = "data/dev/valid.ses.pkl"
    state['valid_rank'] = "data/dev/valid.rnk.pkl"
    state['dictionary'] = "data/dev/train.dict.pkl"
    state['save_dir'] = './models/'
    state['prefix'] = "dev"
...
def dev_large():
    ...
    state['train_session'] = "data/dev_large/train.ses.pkl"
    state['train_rank'] = "data/dev_large/train.rnk.pkl"
    state['valid_session'] = "data/dev_large/valid.ses.pkl"
    state['valid_rank'] = "data/dev_large/valid.rnk.pkl"
    state['dictionary'] = "data/dev_large/train.dict.pkl"
    state['save_dir'] = './models/'
    state['prefix'] = "dev_large"
...
def full():
    ...
    state['train_session'] = "data/all/train.ses.pkl"
    state['train_rank'] = "data/all/train.rnk.pkl"
    state['valid_session'] = "data/all/valid.ses.pkl"
    state['valid_rank'] = "data/all/valid.rnk.pkl"
    state['dictionary'] = "data/all/train.dict.pkl"
    state['save_dir'] = './models/'
    state['prefix'] = "dev_large"
